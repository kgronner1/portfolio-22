...
const Portfolio = (props) => {
  ...
  //"img":require("../../assets/videos/welcome.png")
  const portfolioData = [
    {id:1, "title":"30-Day Challenge", "video":"https://youtu.be/tQBIYLtmVE0", "img":"", "shortText": "Software learning program built with IE6 compliant CSS and JS.", "text":"In-software webapp built with HTML, CSS, JS. Software learning program used by new clients, trial users, and even as part of university curriculums. 45+ lessons that interfaced directly with the software to confirm completion or failure."},
    {id:2, "title":"Video Library", "video":"https://youtu.be/LTUiPZHYJb0", "img":"", "shortText": "Video library built with CSS, JS, PHP, MySQL.", "text":"Webapp built with HTML, CSS, JS, PHP, MySQL. Organized 500+ videos into 13+ categories and an adjusting number of subcategories. Weighted Javascript search based on titles then descriptions. Single state page that adjusted content without reload."},
    {id:3, "title":"Land F/X Mobile App", "video":"https://youtu.be/h2JKltHHWu8", "img":"", "shortText": "Co-authored mobile app built with Xamarin Forms in C#",  "text":"Mobile App built with Xamarin Forms in C#, XAML, PHP, MySQL. Allows account creation. Displays learning video library, upcoming events, and news to clients."},
    {id:4, "title":"Land F/X Purchase", "video":"https://youtu.be/16-7n4VWyMo", "img":"", "shortText": "Purchasing page built with CSS, JS, PHP, MySQL.", "text":"Web application built with HTML, CSS, JS, PHP, MySQL. A purchase page that connects to PayPal's Payflow purchasing API. Simple and clean design. Manages, sanitizes, and updates data in company administration system. Custom control for admins."},
    {id:5, "title":"Flight Event", "video":"https://youtu.be/2rnDThtB5ds", "img":"", "shortText": "Webpage built with some fun animations.", "text":"Webpage built with some fun animations. Invitation page to join a tradeshow event at the San Diego Air and Space Museum."},
